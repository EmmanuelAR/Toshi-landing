...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-foreground/[0.06] bg-background dark:border-white/[0.06]">
      <div className="container-screen py-16 md:py-20">
        ...
        <div className="mt-14 flex flex-col-reverse gap-4 border-t border-foreground/[0.06] pt-6 text-sm text-subtle dark:border-white/[0.06] md:flex-row md:items-center md:justify-between">
          <p>
