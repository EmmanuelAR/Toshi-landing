...
export function PasskeyPrompt({ className }: { className?: string }) {
  return (
    <div
      data-mockup="passkey"
      className={cn(
        "relative w-full max-w-[380px] overflow-hidden rounded-[28px] border border-black/5 bg-white/95 p-6 text-neutral-900 shadow-[0_30px_80px_-30px_rgba(10,10,10,0.4)] backdrop-blur",
    ...
    >
      ...
      <p className="mt-1 text-sm text-neutral-500">
        Use your passkey to sign. Nothing leaves this device.
      </p>
      ...
      <div className="mt-7 flex items-center justify-between rounded-2xl border border-black/[0.06] bg-neutral-50 p-3 text-[13px] dark:border-white/10 dark:bg-white/[0.04]">
        ...
        <span className="font-semibold tabular-nums">$428.50 USD</span>
      </div>
    </div>
  );
}
