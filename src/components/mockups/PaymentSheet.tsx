...
export function PaymentSheet({
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full max-w-[420px] overflow-hidden rounded-[28px] border border-black/5 bg-white text-neutral-900 shadow-[0_30px_80px_-30px_rgba(10,10,10,0.45),0_8px_24px_-12px_rgba(10,10,10,0.25)]",
    ...
    >
      ...
      <div className="px-6 pt-7">
        ...
        <p className="mt-2 text-sm text-neutral-500">{t("mockupItem")}</p>
      </div>

      {!compact && (
        <div className="mt-6 grid grid-cols-3 gap-2 px-6">
          <SmallStat label="Network" value="Toshi" />
          <SmallStat label="Fee" value="0.4%" />
          <SmallStat label="Settle" value="Instant" />
        </div>
      )}
        ...
        <div className="flex items-center justify-between rounded-2xl border border-black/[0.06] bg-neutral-50 p-3 dark:border-white/10 dark:bg-white/[0.04]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium">·· 4290</p>
            </div>
          </div>
