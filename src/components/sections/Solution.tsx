      ...
      <div className="grid lg:grid-cols-12">
        <div className="relative min-h-[420px] lg:col-span-5 lg:min-h-[760px]">
          ...
          <div className="absolute bottom-10 left-8 right-8 lg:left-12 lg:right-auto lg:max-w-sm">
            <span className="inline-flex items-center gap-2 rounded-full border border-foreground/20 bg-foreground/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-foreground/80 backdrop-blur">
              <span className="h-1 w-1 rounded-full bg-mint" />
              {t("eyebrow")}
            </span>
            <p className="mt-4 font-display text-2xl font-semibold leading-tight text-foreground sm:text-3xl">
              Para los que viven de lo que crean.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center px-6 py-20 sm:px-10 md:px-16 lg:col-span-7 lg:py-32">
          ...
          <ul data-reveal className="mt-12 space-y-px overflow-hidden rounded-3xl border border-foreground/10">
