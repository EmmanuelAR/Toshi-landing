      ...
      <div className="container-screen">
        <div data-reveal className="grid items-end gap-10 md:grid-cols-12">
          <div className="md:col-span-8">
            <span className="inline-flex items-center gap-2 rounded-full border border-foreground/10 px-3 py-1 text-[12px] font-medium uppercase tracking-[0.16em] text-muted">
        ...
        <ul data-reveal className="mt-16 grid gap-px overflow-hidden rounded-3xl border border-foreground/[0.08] bg-foreground/[0.06] sm:grid-cols-2 lg:grid-cols-3 dark:border-white/[0.08] dark:bg-white/[0.06]">
          {items.map((item, i) => {
