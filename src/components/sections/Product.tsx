...
export function Product() {
  ...
  return (
    <section ref={ref} id="product" className="bg-foreground/[0.025] py-28 dark:bg-white/[0.02] md:py-36">
      <div className="container-screen">
        ...
        <div data-product-reveal className="mt-12 flex justify-center">
        ...
        <div
          ref={stageRef}
          data-product-reveal
          className="mt-12 grid items-center gap-12 md:grid-cols-12"
        >
          <div className="md:col-span-5">
            ...
            <ul className="mt-6 space-y-2 text-[15px] text-muted">
              <Li>Drop-in SDK & no-code links</Li>
              <Li>Live API, webhooks y exports</Li>
              <Li>Soporte multi-device y multi-wallet</Li>
            </ul>
          </div>
          <div className="relative flex min-h-[520px] items-center justify-center md:col-span-7">
            <div className="pointer-events-none absolute inset-0 -z-10">
              <div className="absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-foreground/[0.04] blur-3xl dark:bg-white/5" />
            </div>
