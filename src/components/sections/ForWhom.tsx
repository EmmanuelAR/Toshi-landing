    ...
    <section ref={ref} id="for-whom" className="py-28 md:py-36">
      <div className="container-screen">
        ...
        <div data-reveal className="mt-16 grid gap-6 lg:grid-cols-12">
          <div
            data-reveal-child
            className="relative overflow-hidden rounded-3xl border border-foreground/[0.06] lg:col-span-5 dark:border-white/[0.06]"
          >
            <div className="relative h-full min-h-[420px] w-full">
              ...
              <div className="absolute bottom-7 left-7 right-7">
                <span className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1 text-[12px] font-medium uppercase tracking-[0.16em] text-white backdrop-blur">
                  Estudio Madera
                </span>
                <p className="mt-3 font-display text-2xl font-semibold leading-tight text-white">
                  De la tienda de barrio al checkout global.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:col-span-7">
            {items.map((item) => (
              <div
                key={item.tag}
                data-reveal-child
                className="group relative flex flex-col gap-3 rounded-3xl border border-foreground/[0.06] bg-background p-7 transition-colors hover:border-foreground/20 dark:border-white/[0.06] dark:hover:border-white/20"
              >
                <span className="inline-flex w-fit items-center gap-2 rounded-full border border-foreground/10 px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-muted dark:border-white/10">
