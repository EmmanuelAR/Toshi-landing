      ...
      <div className="container-screen">
        <div data-reveal className="grid items-center gap-12 md:grid-cols-12">
          <div className="md:col-span-7">
            <div className="inline-flex items-center gap-2 rounded-full border border-foreground/20 px-3 py-1 text-[12px] font-medium uppercase tracking-[0.16em] text-foreground/70">
            ...
            <ul className="mt-10 grid gap-px overflow-hidden rounded-3xl border border-foreground/10 bg-foreground/10 sm:grid-cols-2">
              {items.map((item, i) => (
                <li
                  key={item.title}
                  data-reveal-child
